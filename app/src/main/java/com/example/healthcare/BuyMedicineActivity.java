...
public class BuyMedicineActivity extends AppCompatActivity {
    ...
    private String[][] packages = {
            ...
            { "Strepsils Medicated Lozenges for Sore Threat", "", "", "", "40" },
    ...
    public String[] package_details=
    {
            "Reduce the Body Temperature\n"+
                "Pain Killer",
            "It is an antiemetic medicine used to Control Nausea and Vomiting",
            ...
            "It promotes health as well as skin benefit.\n"+
                    "It helps reduce skin bemish and pigmentation.\n"+
            ...
            "Relieves the symptoms of a bacterial throat infection aand soothes the recovery process\n"+
                    "Provides a warm and comforting feeeling during sore throat",
